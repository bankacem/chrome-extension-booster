...
const MANUAL_PRIORITY_URLS = [
  `${BASE_URL}/blog/ai-formula-generator-excel-vs-google-sheets`,
  `${BASE_URL}/blog/google-sheets-automation-with-ai-2026`,
  `${BASE_URL}/blog/chatgpt-for-google-sheets-workflows`,
  `${BASE_URL}/blog/best-ai-tools-data-entry-automation-2026`,
  `${BASE_URL}/blog/poper-blocker-vs-adblock-plus-2026`,
  `${BASE_URL}/blog/adguard-vs-ghostery-2026-comparison`,
  `${BASE_URL}/blog/what-are-tracking-cookies-remove-chrome`,
  `${BASE_URL}/blog/youtube-downloader-safety-checklist-2026`,
  `${BASE_URL}/blog/tag-assistant-legacy-vs-companion-2026`,
  `${BASE_URL}/blog/is-youtube-to-mp3-legal-2026-guide`,
  `${BASE_URL}/blog/youtube-playlist-to-mp3-batch-conversion`,
  `${BASE_URL}/blog/youtube-to-mp3-iphone-android-2026`,
  `${BASE_URL}/blog/how-to-edit-mp3-tags-id3`,
  `${BASE_URL}/blog/youtube-premium-vs-mp3-converter-2026`,
  `${BASE_URL}/blog/best-audio-downloaders-podcast-2026`,
  `${BASE_URL}/blog/best-adblock-browser-for-android-2026`,
  `${BASE_URL}/blog/kiwi-browser-review-2026`,
  `${BASE_URL}/blog/block-ads-youtube-app-android`,
  `${BASE_URL}/blog/adguard-dns-setup-guide-android-router-pc`,
  `${BASE_URL}/blog/stop-notification-ads-chrome-android`,
  `${BASE_URL}/blog/samsung-internet-adblock-setup-guide`,
  `${BASE_URL}/blog/firefox-android-extensions-guide`,
