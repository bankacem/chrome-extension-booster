...
|---|---|---|---|---|---|---|
| Worker-01 | How to Get the Most Out of Your Browser with Chrome Extensions | `public/content/articles/h/o/w/how-to-get-the-most-out-of-your-browser-with-extension-chrome-get.md` | `how-to-get-the-most-out-of-your-browser-with-extension-chrome-get` | `refine/recover-worker-01` | `ready_for_merge` | Recovered on a new branch; audit added; HTML 14,940 bytes; Article 1, BreadcrumbList 1, FAQPage 0; full checks passed on integration branch |
...
| Worker-03 | How to Fix Chrome High Memory Usage: A Diagnostic Guide | `public/content/articles/h/o/w/how-to-fix-chrome-high-memory-usage-the-ultimate-2026-speed-up-guide.md` | `how-to-fix-chrome-high-memory-usage-the-ultimate-2026-speed-up-guide` | `refine/recover-worker-03` | `ready_for_merge` | Recovered on a new branch; malformed markup and unsupported benchmarks removed; HTML 15,816 bytes; Article 1, BreadcrumbList 1, FAQPage 0; full checks passed on integration branch |
| Worker-04 | Chrome Extensions for Students: Build a Practical Academic Stack | `public/content/articles/p/r/o/pro-student-chrome-extensions-the-ultimate-academic-stack.md` | `pro-student-chrome-extensions-the-ultimate-academic-stack` | `refine/recover-worker-04` | `ready_for_merge` | Recovered on a new branch; academic workflow and privacy limits rewritten; HTML 18,052 bytes; Article 1, BreadcrumbList 1, FAQPage 0; full checks passed on integration branch |
...
| Worker-08 | How to Create Complex Excel Formulas Easily: A Practical Method | `public/content/articles/h/o/w/how-to-create-complex-excel-formulas-easily.md` | `how-to-create-complex-excel-formulas-easily` | `refine/recover-worker-08` | `ready_for_merge` | Recovered on a new branch; formula examples and compatibility notes corrected; original article ID preserved; HTML 17,387 bytes; Article 1, BreadcrumbList 1, FAQPage 0; full checks passed on integration branch |
...
- **Decision:** The four articles are ready for the integration PR. They must not be marked `merged` until the integration branch is merged into `main` and the post-merge publish workflow succeeds.

### Rejected or blocked branches

The historical blocked/needs-revision notes above were superseded by the recovery integrations recorded in the section above. The current authoritative status is the worker table at the top of this file: Workers 01, 03, 04, and 08 are `ready_for_merge` on `integration/recover-workers-1348`; Workers 02, 05, and 06 are already `merged` on main.
