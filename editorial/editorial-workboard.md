...
| Worker-05 | Professional Browser Tools Guide | `public/content/articles/p/r/o/professional-browser-tools-guide.md` | `professional-browser-tools-guide` | `refine/professional-browser-tools-guide` | `ready_for_merge` | Recovered on repair/wave-2; article and audit reviewed; full release checks passed |
| Worker-06 | Mastering Google Chrome Programmé en | `public/content/articles/g/o/o/google-chrome-programm-en-14.md` | `google-chrome-programm-en-14` | `refine/google-chrome-programm-en-14` | `ready_for_merge` | Recovered on repair/wave-2; unrelated evaluator.py change removed, audit added, redirect fixed, and full release checks passed |
