...
<ul>
  <li>Q: What is the best fast screenshot extension for Chrome?
    <ul>
      <li>A: underline">Quick Screenshot Lite</a> is a popular and highly-rated fast screenshot extension for Chrome.</li>
    </ul>
  </li>
  ...
  <li>Q: How does Quick Screenshot Lite compare to other screenshot extensions?
    <ul>
      <li>A: underline">Quick Screenshot Lite</a> offers a unique combination of features, including full-page screenshots, visible area screenshots, instant capture, and easy sharing. Please see the comparison table above for more information.</li>
    </ul>
  </li>
  <li>Q: Can I use Quick Screenshot Lite in conjunction with other Chrome extensions?
    <ul>
      <li>A: underline">Quick Screenshot Lite</a> can be used in conjunction with other Chrome extensions, such as <a href="/extension/auto-dark-mode-switcher" class="text-primary font-medium hover: underline">Auto Dark Mode Switcher</a> and <a href="/extension/redirect-shield" class="text-primary font-medium hover: underline">Redirect Shield</a>.</li>
    </ul>
  </li>
</ul>
