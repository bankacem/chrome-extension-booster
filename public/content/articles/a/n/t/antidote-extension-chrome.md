...
**Dictionaries.** 11 French dictionaries covering synonyms, antonyms, conjugations, word families, and proper names. Right-click any word in your browser to open the dictionary in a popup. Faster than opening a separate tab for WordReference or Larousse.

**Spell Checker.** Real-time underlining of spelling errors in any text field — Gmail, Twitter, WordPress, Google Docs. Works offline.

**Rephrasing Tool.** Select a sentence and Antidote suggests alternative phrasings. Useful but less sophisticated than Grammarly's tone suggestions — it rephrases rather than adjusting for tone or formality.

**Guides.** 30 interactive guidebooks on writing rules: typography, punctuation, inclusive writing, quotes, numbers. Accessible directly from the Chrome extension. I found the inclusive writing guide particularly useful — it explains gender-neutral alternatives in French, a topic most English-focused tools ignore entirely.

**Offline mode.** The Chrome extension works offline once the desktop app is installed. This is a significant advantage over Grammarly, which requires an internet connection for all features. I tested Antidote's offline mode on a 2-hour flight and it caught the same errors it would have caught online. All dictionaries, grammar rules, and guidebooks were available without connectivity.

## Antidote vs Grammarly vs ProWritingAid {#vs}

| Feature | Antidote | Grammarly | ProWritingAid |
|---------|----------|-----------|---------------|
| French grammar | Excellent (11 dictionaries, 410 rules) | Basic | None |
| English grammar | Good | Excellent | Excellent |
| Vocabulary suggestions | Yes (dictionaries + thesaurus) | Yes (tone-based) | Yes (style-based) |
| Rephrasing | Yes | Yes (tone-aware) | Yes (style-aware) |
| Offline mode | Yes | No | Yes |
| Google Docs integration | Yes | Yes | Yes |
| Gmail integration | Yes | Yes | Yes |
| Price | $60/year (all platforms) | $12/mo Premium | $10/mo |
| Free version | 30-day trial | Basic checker | 10-day trial |
| Languages | French + English | English only | English only |
...
Antidote costs $60/year for all platforms (Windows, Mac, iOS, Chrome, Firefox, Edge). This is cheaper than Grammarly Premium ($144/year) but more than the basic Grammarly free tier. A 30-day free trial is available.
...
**Q: Is Antidote free?**  
A: 30-day free trial, then $60/year.

**Q: Does Antidote work offline?**  
A: Yes. The Chrome extension works offline once the desktop app is installed.

**Q: Does Antidote work on Google Docs?**  
A: Yes. It integrates directly into the Google Docs toolbar.

**Q: Can Antidote check English?**  
A: Yes, but Grammarly is stronger for English. Antidote's strength is French.

**Q: Does Antidote need a desktop app?**  
A: Yes. The Chrome extension is a companion to the Antidote desktop application.
