...
keywords:
  ...
  - print from chrome
meta_description: >-
  I tested Chrome's built-in printing, cloud print services, and PDF-first
  workflows across 5 printer models. Here is how to print from Chrome without
  wasting paper or time.
status: published
...
- Printer selection (local, network, or cloud-connected)
...
For standard document printing (letters, invoices, contracts):
- Layout: Portrait
...
For web page printing (articles, recipes, tutorials):
- Use Chrome's "Reader mode" first (Ctrl+Shift+R) to strip ads and sidebars
...
For printing shipping labels or forms:
- Set margins to "Custom" with 0.5 inches all around
