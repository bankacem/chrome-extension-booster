...
![IE Tab for Chrome: Run Legacy Sites, Configure URL Rules, and Manage the Risks Overview](/content/images/ie-tab-chrome-legacy-sites-guide/ie-tab-chrome-legacy-sites-guide-overview.webp "IE Tab for Chrome: Run Legacy Sites, Configure URL Rules, and Manage the Risks Overview")

![IE Tab for Chrome: Run Legacy Sites, Configure URL Rules, and Manage the Risks Details](/content/images/ie-tab-chrome-legacy-sites-guide/ie-tab-chrome-legacy-sites-guide-details.webp "IE Tab for Chrome: Run Legacy Sites, Configure URL Rules, and Manage the Risks Details")
