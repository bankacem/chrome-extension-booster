...
- Security extensions, such as [Redirect Shield](/extension/redirect-shield), which protects you from malicious redirects and phishing attacks.
...
| --- | --- | --- |
| [Quick Screenshot Lite](/extension/quick-screenshot-lite) | Capture full-page screenshots | Full-page screenshots, visible area screenshots, image editing |
| [Auto Dark Mode Switcher](/extension/auto-dark-mode-switcher) | Automatically switch between light and dark modes | Automatic mode switching, custom scheduling, system theme integration |
| [ProTab Suspender](/extension/protab-suspender) | Suspend inactive tabs to save memory | Automatic tab suspension, custom suspension rules, memory usage tracking |
