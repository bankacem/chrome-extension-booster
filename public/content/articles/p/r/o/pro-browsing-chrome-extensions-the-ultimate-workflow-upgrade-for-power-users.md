...
<p><!-- /wp: 4} --></p>
<h4 class="wp-block-heading">The Template Strategy: paragraph --></p>
<p>Do not just clip the page. Set up templates for different content types: list-item -->
...
<p><!-- /wp: paragraph --></p>
<p><strong>Why it&rsquo;s Pro: list-item -->
...
<p><!-- /wp: 4} --></p>
<h4 class="wp-block-heading">How to Configure Hard Mode: list {"ordered": true} --></p>
...
<p><!-- /wp: paragraph --></p>
<p><strong>Pro Use Cases: list-item -->
...
<p><!-- /wp: paragraph --></p>
<p>Installing these extensions is step one. Integrating them is step two. Here is what a "Pro Session" looks like: paragraph --></p>
